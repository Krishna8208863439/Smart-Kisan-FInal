              ...
              <div style={{ background: "#0f172a", padding: "18px", borderRadius: "14px", color: "white", display: "flex", flexDirection: "column", gap: "14px" }}>
                ...
                >
                  ...
                  >
                    ...
                    >
                      <img
                        src="/krishna_qr_square.png"
                        onError={(e) => {
                          e.target.onerror = null;
                          e.target.src = `https://api.qrserver.com/v1/create-qr-code/?size=200x200&margin=4&data=${encodeURIComponent(`upi://pay?pa=krishnadevadkar@okaxis&pn=Krishna%20Devadkar&am=${grandTotal}&cu=INR&tn=Kisan%20Bazaar%20Order`)}`;
                        }}
